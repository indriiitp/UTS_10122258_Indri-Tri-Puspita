...
<head>
    ...
    <title>Welcome To Keroffee</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <?php include 'Model/mStatus.php'; ?>
    <?php include 'View/vHeader.php'; ?>
    ...
    <div class="boxinti1">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class=" p-5 shadow katalogdashboard">
                                ...
                                <a href="katalog.php" class="btn btn-warning">Lihat Daftar</a>
                            </div>
                        </div>
                        <div class="col">
                            <div class=" p-5 shadow katalogdashboard">
        ...
        <?php
        // Periksa apakah logout berhasil dari query string
